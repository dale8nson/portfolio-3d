...
export const BoxCollider = forwardRef(function BoxCollider({ name = "", scale = vec3(1, 1, 1), position = vec3(0, 0, 0), rotation = new THREE.Euler(0, 0, 0), debug=false }, ref=null) {

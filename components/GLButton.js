...
export const GLButton = forwardRef(function GLButton({ position, emissive, onClick = () => null, onPointerEnter, onPointerLeave, children }, ref) {
  ...
  return (
    <>
      <motion.mesh position={position} initial={{ z: 0 }} scale={vec3(0.75, 0.75, 0.5)} whileHover={{ z: 1 }} transition={{ duration: 0.5 }} onClick={onClick} ref={ref} >

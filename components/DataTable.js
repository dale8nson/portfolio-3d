...
export const DataTable = () => {
  ...
  return (
    <div className='h-[90%] w-screen p-2 flex-col  flex-col w-11/12 mx-auto mb-4 border-solid border-black bg-white border-2 rounded-md' >
      <div  className=" h-[95%] relative z-0 mb-4 pb-4 rounded-md border-solid border-black border-2 overflow-scroll ">

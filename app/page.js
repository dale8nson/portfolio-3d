      ...
      <Canvas ref={canvasRef} camera={{manual:false}}>
        ...
        <motion.group initial={{rotateY:-6}} animate={{rotateY:3}} transition={{duration:24, repeatType:'mirror', repeat:Infinity}} >
          ...
          {envMap && <motion.group initial={{ x: -1, y: 4, z: 5, rotateY: 13, rotateX: 0, originX: 0.5, originY: 0.5, originZ: 0 }} animate={{ x: -1.25, y: 1, z: 0, rotateY: 0, rotateX: 0, originX: 0.5, originY: 0.5, originZ: 0 }} transition={{ duration: 5 }} style={{ originX: 0.5, originY: 0.5, originZ: 0 }} >
            <Text3D position={vec3(1.2, 0, 0)} scale={vec3(0.4, 1.3, 1)} font='/Itai Protests_Regular.json' bevelEnabled bevelSegments={10} bevelSize={.0005} bevelThickness={0.004} style={{ transformOrigin: '50% 50%' }} ref={initTextNode} >
